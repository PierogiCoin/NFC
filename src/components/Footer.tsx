...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100 py-14 px-6 md:px-12 mt-16 rounded-t-3xl shadow-inner border-t border-slate-800/60">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 -top-24 h-48 bg-[radial-gradient(ellipse_at_top,rgba(56,189,248,0.18),transparent_60%)]"
      />
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 -bottom-20 h-44 bg-[radial-gradient(ellipse_at_bottom,rgba(99,102,241,0.18),transparent_60%)]"
      />
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
        ...
        {/* Kolumna: linki szybkie (wewnętrzne -> Link) */}
        <nav className="grid grid-cols-2 gap-y-2 gap-x-8 text-sm md:text-[15px]">
          <Link href="/" className="text-slate-300/90 hover:text-sky-300 transition">
            Strona główna
          </Link>
          <Link href="/bjj" className="text-slate-300/90 hover:text-sky-300 transition">
            BJJ
          </Link>
          <Link href="/mma" className="text-slate-300/90 hover:text-sky-300 transition">
            KickBoxing
          </Link>
          <Link href="/kobiety" className="text-slate-300/90 hover:text-sky-300 transition">
            Sekcja Kobiet
          </Link>
          <Link href="/kettlebell" className="text-slate-300/90 hover:text-sky-300 transition">
            Kettlebell
          </Link>
          <Link href="/blog" className="text-slate-300/90 hover:text-sky-300 transition">
            Blog
          </Link>
          <Link href="/grafik" className="text-slate-300/90 hover:text-sky-300 transition">
            Grafik
          </Link>
          <Link href="/kontakt" className="text-slate-300/90 hover:text-sky-300 transition">
            Kontakt
          </Link>
        </nav>

        {/* Kolumna: social + newsletter */}
        <div className="flex flex-col items-center md:items-end gap-5">
          <div className="flex space-x-5 md:space-x-4">
            {[
              ...
              >
                <svg
                  className="w-7 h-7 text-white transition-colors group-hover:text-sky-300"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                >
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
        ...
        <div className="text-xs md:text-sm text-slate-400/90 flex flex-wrap items-center gap-x-4 gap-y-2">
          <Link href="/regulamin" className="hover:text-sky-300 transition">
            Regulamin
          </Link>
          <span className="opacity-30">•</span>
          <Link href="/polityka-prywatnosci" className="hover:text-sky-300 transition">
            Polityka prywatności
          </Link>
          <span className="opacity-30">•</span>
          <Link href="/kontakt" className="hover:text-sky-300 transition">
            Kontakt
          </Link>
        </div>
      </div>
